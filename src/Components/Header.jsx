...
const Header = ({ searchHandler, handleLogout, filterByCategory }) => {
    ...
    const handleSearch = (e) => {
        ...
        searchHandler(e.target.value);  // Call the passed handler
    };
...
// Add PropTypes to validate the props passed to the component
Header.propTypes = {
    searchHandler: PropTypes.func.isRequired,   // Search handler function is required
    handleLogout: PropTypes.func.isRequired,    // Logout handler function is required
    filterByCategory: PropTypes.func.isRequired // Category filter function is required
};
